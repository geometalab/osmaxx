...
|leisure|swimming_pool|amenity='swimming_pool' leisure='swimming_pool' sport='swimming_pool' |A swimming pool is a place built for swimming as a recreational activity or sport, typically taking the form of an excavated and lined pool|
...
|bus|bus_stop|railway='bus_stop' public_transport='stop_position' bus='yes' |A bus stop is a place where public buses stop.|
...
|railway|railway_halt|railway='halt' public_transport='stop_position' train='yes' |A small station, may not have a platform, trains may only stop on request.|
...
|aggtype             |values              |osm_tags            |description                                                           |
| ------------------ | ------------------ | ------------------ | -------------------------------------------------------------------- |
|station|fossil|power='generator' generator:source='gas' generator:source='coal' |Using the combustion of fuels to heat the water to in turn spin the generators turbine |
|station|hydro|power='generator' generator:source='water' power_source='hydro' |Hydroelectricity is the term referring to electricity generated by hydropower; the production of electrical power through the use of the gravitational force of falling or flowing water. It is the most widely used form of renewable energy.|
|station|nuclear|power='generator' generator:source='nuclear' |A nuclear power plant is a thermal power station in which the heat source is one or more nuclear reactors.|
|power|power|power='*' |All other types of power which is not defined as above|
|station|solar|power='generator' generator:source='solar' power_source='photovoltaic' |Solar powerplant does conversion of sunlight into electricity, either directly using photovoltaics (PV), or indirectly using concentrated solar power (CSP).|
...
|station|wind|power='generator' generator:source='wind' power_source='wind' |A wind turbine is a device that converts kinetic energy from the wind into mechanical energy. If the mechanical energy is used to produce electricity, the device may be called a wind generator.|
