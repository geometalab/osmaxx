...
|track|track|`highway=track`+<code>tracktype<strong>&ne;\*</strong></code>+**`junction≠roundabout`**|Roads for agricultural use, gravel roads in the forest etc. and no tracktype tag is present|
