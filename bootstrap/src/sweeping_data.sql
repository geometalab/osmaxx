...
INSERT INTO temp
select
osm_id, "access", "addr:city", "addr:housenumber", "addr:interpolation", "addr:place", "addr:postcode", "addr:street","addr:country", admin_level, aerialway, aeroway, amenity, area, barrier, brand, bridge, boundary, building, bus, "contact:phone", cuisine, denomination, drinkable, ele, emergency, entrance, foot, frequency, "generator:source", height, highway, historic, information, junction, landuse, layer, leisure, man_made, maxspeed, military, name, int_name, "name:en", "name:de", "name:fr", "name:es", "natural",office, oneway, opening_hours, operator, phone, "power", power_source, parking, place, population, public_transport, "recycling:glass", "recycling:paper",  "recycling:clothes", "recycling:scrap_metal", railway, "ref", religion, route, service, 
...
INSERT INTO temp
select
osm_id, "access", "addr:city", "addr:housenumber", "addr:interpolation", "addr:place", "addr:postcode", "addr:street","addr:country", admin_level, aerialway, aeroway, 
