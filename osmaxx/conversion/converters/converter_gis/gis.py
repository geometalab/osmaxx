...
from osmaxx.conversion.converters.boundaries import pbf_area
...
class GISConverter:
    ...
    def create_gis_export(self):
        with pbf_area(osmosis_polygon_file_content=self._polyfile_string) as pbf_path:
            assert pbf_path is not None
