...
ROUTE_TYPES = 'bicycle bus canoe detour ferry hiking horse inline_skates light_rail mtb nordic_walking pipeline piste power railway road running ski train tram route'.split()
