    ...
    def test_scripts_are_executed_in_correct_order(self, *args, **kwargs):
        ...
        with mock.patch.object(bootstrapper, '_postgres') as postgres_mock:
            ...
            expected_script_order = [
                ...
                'sql/filter/create_view/view_address.sql',
                'sql/filter/create_view/view_adminarea.sql',
                'sql/filter/create_view/view_boundary.sql',
                'sql/filter/create_view/view_building.sql',
                'sql/filter/create_view/view_geoname_l.sql',
                'sql/filter/create_view/view_geoname_p.sql',
                'sql/filter/create_view/view_landuse_a.sql',
                'sql/filter/create_view/view_military_a.sql',
                'sql/filter/create_view/view_military_p.sql',
                'sql/filter/create_view/view_misc_l.sql',
                'sql/filter/create_view/view_natural_a.sql',
                'sql/filter/create_view/view_natural_p.sql',
                'sql/filter/create_view/view_nonop_l.sql',
                'sql/filter/create_view/view_poi_a.sql',
                'sql/filter/create_view/view_poi_p.sql',
                'sql/filter/create_view/view_pow_a.sql',
                'sql/filter/create_view/view_pow_p.sql',
                'sql/filter/create_view/view_railway_l.sql',
                'sql/filter/create_view/view_road_l.sql',
                'sql/filter/create_view/view_route_l.sql',
                'sql/filter/create_view/view_traffic_a.sql',
                'sql/filter/create_view/view_traffic_p.sql',
                'sql/filter/create_view/view_transport_a.sql',
                'sql/filter/create_view/view_transport_l.sql',
                'sql/filter/create_view/view_transport_p.sql',
                'sql/filter/create_view/view_utility_a.sql',
                'sql/filter/create_view/view_utility_l.sql',
                'sql/filter/create_view/view_utility_p.sql',
                'sql/filter/create_view/view_water_a.sql',
                'sql/filter/create_view/view_water_l.sql',
                'sql/filter/create_view/view_water_p.sql',
            ]
            expected_calls = [
                mock.call(
                    os.path.join(
