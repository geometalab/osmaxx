    ...
    def test_scripts_are_executed_in_correct_order(self, *args, **kwargs):
        ...
        with mock.patch.object(bootstrapper, '_postgres') as postgres_mock:
            ...
            expected_script_order = [
                ...
                'sql/filter/create_view/0110_view_address.sql',
                'sql/filter/create_view/0210_view_adminarea.sql',
                'sql/filter/create_view/0310_view_boundary.sql',
                'sql/filter/create_view/0410_view_building.sql',
                'sql/filter/create_view/0510_view_geoname_l.sql',
                'sql/filter/create_view/0520_view_geoname_p.sql',
                'sql/filter/create_view/0610_view_landuse_a.sql',
                'sql/filter/create_view/0710_view_military_a.sql',
                'sql/filter/create_view/0720_view_military_p.sql',
                'sql/filter/create_view/0810_view_misc_l.sql',
                'sql/filter/create_view/0910_view_natural_a.sql',
                'sql/filter/create_view/0920_view_natural_p.sql',
                'sql/filter/create_view/1010_view_nonop_l.sql',
                'sql/filter/create_view/1110_view_pow_a.sql',
                'sql/filter/create_view/1120_view_pow_p.sql',
                'sql/filter/create_view/1210_view_poi_a.sql',
                'sql/filter/create_view/1220_view_poi_p.sql',
                'sql/filter/create_view/1310_view_railway_l.sql',
                'sql/filter/create_view/1410_view_road_l.sql',
                'sql/filter/create_view/1510_view_route_l.sql',
                'sql/filter/create_view/1610_view_traffic_a.sql',
                ...
                'sql/filter/create_view/1910_view_water_a.sql',
                'sql/filter/create_view/1920_view_water_p.sql',
                'sql/filter/create_view/1930_view_water_l.sql',
            ]
            expected_calls = [
                mock.call(
                    os.path.join(
