...
def test_scripts_are_executed_in_correct_order(sql_scripts_filter, sql_scripts_create_view):
    ...
    with mock.patch.object(bootstrapper, '_postgres') as postgres_mock:
        ...
        expected_script_order = sql_scripts_filter + sql_scripts_create_view
        expected_calls = [
            mock.call(
                os.path.join(
