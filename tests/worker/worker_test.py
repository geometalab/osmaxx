...
class WorkerTest(TestCase):
    ...
    @mock.patch('conversion_service.converters.gis_converter.bootstrap.bootstrap.boostrap', return_value=None)
    @mock.patch('conversion_service.converters.osm_cutter.cut_osm_extent', return_value=pbf_file_path)
