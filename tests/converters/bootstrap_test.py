    ...
    def test_scripts_are_executed_in_correct_order(self, *args, **kwargs):
        ...
        with mock.patch.object(bootstrapper, '_postgres') as postgres_mock:
            ...
            expected_script_order = [
                ...
                'sql/filter/water/000_water_a_create_table.sql',
                'sql/filter/water/010_water_a_insert_table.sql',
                'sql/filter/water/020_water_b_create_table.sql',
                'sql/filter/water/030_water_b_insert_table.sql',
                'sql/filter/water/040_water_l_create_table.sql',
                'sql/filter/water/050_water_l_insert_table.sql',
