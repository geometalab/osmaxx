from converters.gis_converter.extract.statistics.osm_groups import BOUNDARIES, SETTLEMENTS, LANDUSES, MILITARY_AREAS, \
    MISC_LINES, NATURAL_AREAS, NATURAL_POIS, HIGHWAY_RAILWAY_TYPES, PLACES_OF_WORSHIP, PUBLIC_POIS, RECYCLING_POIS, \
    EDUCTATION_POIS, HEALTH_POIS, LEISURE_POIS, CATERING_POIS, ACCOMODATION_IN_POIS, ACCOMODATION_OUT_POIS, SHOP_POIS, \
    VENDING_POIS, MONEY_POIS, TOURISM_POIS, DESTINATION_POIS, MISC_POIS, SPORT, MAN_MADE, HISTORIC, AMENITY, \
    RAILWAY_TYPES, ROAD_TYPES, ROUNDABOUT_TYPES, ROUTE_TYPES, TRAFFIC_AREA_TYPES, TRAFFIC_POINTS_TYPES, \
    TRANSPORT_AREAS_TYPES, UTILITY_AREA_TYPES, UTILITY_POINTS_TYPES, UTILITY_LINES_TYPES, PIPELINE, WATER_AREA_TYPES, \
    WATER_POINT_TYPES, WATER_LINE_TYPES
