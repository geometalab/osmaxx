...
cmd="./estimate_size.py $infile 8 47 9 48"
...
cmd="./estimate_size.py $infile 7.9999 46.9999 9.0001 48.0001"
...
cmd="./estimate_size.py $infile 8.0001 47.0001 8.9999 47.9999"
...
cmd="./estimate_size.py $infile -44 -23 -43 -22"
...
cmd="./estimate_size.py $infile 8 47 10 49"
...
cmd="./estimate_size.py $infile -90 -180 89 179"
