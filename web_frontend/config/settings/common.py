...
OSMAXX = {
    ...
    'OLD_RESULT_FILES_REMOVAL_DAYS': timezone.timedelta(
        days=env.int('DJANGO_OSMAXX_OLD_RESULT_FILES_REMOVAL_DAYS', default=14)
    ),
    'OLD_RESULT_FILES_REMOVAL_CHECK_INTERVAL_HOURS': timezone.timedelta(
